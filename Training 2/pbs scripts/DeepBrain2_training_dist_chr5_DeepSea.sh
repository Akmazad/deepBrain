...
#PBS -l wd
#PBS -o deepBrain2_train_dist_np_chr5_DeepSea.out
#PBS -e deepBrain2_train_dist_np_chr5_DeepSea.err
#PBS -l ncpus=24
#PBS -l ngpus=8
#PBS -P yr31
...
# exec numactl --membind=${numa_node} --cpunodebind=${numa_node} -- \
  python3 /short/yr31/aa7970/azData/DeepBrain/Scripts/deepbrain2_dist_DeepSEA_data.py  \
    --name deepbrainStaticConvnet_chr5_DeepSEA \
    --DataDir Data/ \
    --TrainingDataFile DeepSEA_train.mat \
    --TestingDataFile DeepSEA_test.mat \
    --nEpochs 10 \
    --BATCH_SIZE 16 \
    --NUM_OUTPUTS 911 \
