...
#PBS -l wd
#PBS -o deepbrain3_DARTS_dist.out
#PBS -e deepbrain3_DARTS_dist.err
#PBS -l ncpus=24
#PBS -l ngpus=8
#PBS -P yr31
...
# exec numactl --membind=${numa_node} --cpunodebind=${numa_node} -- \
  python3 /short/yr31/aa7970/azData/DeepBrain/Scripts/deepbrain3_DARTS_dist.py  \
    --name deepbrain3_DARTS \
    --DataDir Data/ \
    --TrainingDataFile H3K27ac_rnaSeq.Pos.tfSpecific_trainingData_chr5_value.npy \
    --TrainingLabelFile H3K27ac_rnaSeq.Pos.tfSpecific_trainingData_chr5_label_all.npy \
    --TestingDataFile H3K27ac_rnaSeq.Pos.tfSpecific_validationData_chr5_value.npy \
    --TestingLabelFile H3K27ac_rnaSeq.Pos.tfSpecific_validationData_chr5_label_all.npy \
    --nEpochs 1 \
    --BATCH_SIZE 128 \
    --NUM_OUTPUTS 131 \
