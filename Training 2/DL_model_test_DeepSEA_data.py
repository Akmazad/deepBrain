...
parser.add_argument('--w_weight_decay', type=float, default=1e-12)
...
def main():
    ...
    try:
        ...
        trainDataset = LoadDataset(args, dataPath=DataPath, dataFile=args.TrainingDataFile, dataType="testData")
        # define sampler
        ...
        valDataset = LoadDataset(args, dataPath=DataPath, dataFile=args.TestingDataFile,  dataType="validData")
